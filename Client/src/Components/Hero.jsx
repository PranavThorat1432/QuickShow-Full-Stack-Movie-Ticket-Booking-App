  ...
  return (
    ...
    >
        ...
        <div className='flex items-center gap-4 text-gray-300'>
            <span>Acion | Adventure | Sci-Fi</span>
        ...
        <button onClick={() => navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full cursor-pointer font-medium'>
            Explore Movies
